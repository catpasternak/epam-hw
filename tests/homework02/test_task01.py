...
def test_longest_diverse_words():
    ...
    assert task01.get_longest_diverse_words(_path_to("sample01_task01.txt")) == [
        "vorzutäuschen",
        "Fruchtbarkeit",
        "herabgesunken",
        "ungeschwächt",
